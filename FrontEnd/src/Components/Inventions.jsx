...
function Inventions() {
  return (
    <div className="flex justify-center items-center h-screen bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black shadow-2xl relative overflow-hidden">
      <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-100 to-gray-300 rounded-lg shadow-lg p-8 max-w-screen-md transform rotate-3'>
        <h1 className='text-gray-900 text-center text-5xl font-bold mb-12'>👽 Useless and Weird Inventions 👽</h1>
        ...
        <div className="flex justify-center items-center">
          <Link to='/main'><button className="bg-gray-700 text-white px-8 py-4 rounded-full shadow-lg hover:bg-gray-900 duration-300 hover:scale-110">Get Started</button></Link>
        </div>
      </div>
