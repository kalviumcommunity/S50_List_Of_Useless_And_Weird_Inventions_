...
function Inventions() {
  return (
    <div className="flex justify-center items-center h-screen bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-yellow-200 via-yellow-400 to-yellow-700 shadow-2xl">
      ...
      <p className="text-xl text-gray-800 text-center mb-4">Welcome to the realm of oddities! Explore mind-bending inventions that defy logic and reason. 😄 😜</p>
        ...
        <button className="bg-yellow-600 text-white px-8 py-4 rounded-full shadow-lg hover:bg-yellow-700 duration-300 hover:scale-110">Embark on the Journey</button>
        </div>
      </div>
